...
namespace ReadingHub.Persistence.Migrations
{
    ...
    [Migration("20221001072754_ReadingNotes")]
    partial class ReadingNotes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReadingHub.Persistence.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("CommentDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 10, 1, 9, 27, 53, 963, DateTimeKind.Local).AddTicks(9037));
            ...
            modelBuilder.Entity("ReadingHub.Persistence.Models.Post", b =>
                {
                    ...
                    b.Property<DateTime>("PostTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 1, 9, 27, 53, 963, DateTimeKind.Local).AddTicks(9488));
            ...
            modelBuilder.Entity("ReadingHub.Persistence.Models.Reading", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReadingHub.Persistence.Models.ReadingNotes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ReadingHub.Persistence.Models.ReadingNotes", b =>
                {
                    b.HasOne("ReadingHub.Persistence.Models.Reading", "Reading")
                        .WithMany()
